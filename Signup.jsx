...
const Signup = () => {
    ...
    const validate = () => {
        ...
        else if (!phoneRegex.test(input.phoneNumber)) newErrors.phoneNumber = "Phone number must be 10 digits";
    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-center min-h-screen px-4'>
                <form onSubmit={submitHandler} className='w-full max-w-xl border border-gray-500 rounded-md p-6 my-10 shadow-sm bg-white'>
